...
export const { useGetUserQuery, useEditProfileMutation, useGetFriendsQuery, useGetUserNotFriendsQuery, useAddRemoveFriendMutation, useUpdateProfilePicMutation, useSearchUserQuery } = userApi;